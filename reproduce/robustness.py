...
model.fit(np.concatenate((X_adv_0[:300],X_train)), np.concatenate((Y_test_filtered[:300],Y_train)), verbose=False)
...
evl = model.evaluate(X_adv_0[300:],Y_test_filtered[300:])
print(evl)
